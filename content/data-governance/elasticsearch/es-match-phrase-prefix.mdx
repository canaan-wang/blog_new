---
title: "match_phrase_prefix 短语前缀匹配查询"
date: "2025-12-30"
summary: "`match_phrase_prefix` 是 Elasticsearch 中专为即时搜索和联想提示设计的查询语句，它结合了短语匹配和前缀匹配的特性，能够高效处理用户输入未完成时的检索需求。"
tags: ["ElasticSearch", "Match Phrase Prefix"]
