---
title: "multi_match 多字段匹配查询"
date: "2025-12-30"
summary: "`multi_match` 是 Elasticsearch 中实现跨多个字段全文检索的核心查询类型，它允许使用同一个查询字符串同时在多个 text 类型字段上执行 match 查询，并合并结果。"
tags: ["ElasticSearch", "Multi Match"]
