---
title: "Olivere/Elastic 框架使用指南"
date: "2025-12-28"
summary: "`olivere/elastic` 是 Go 语言中操作 Elasticsearch 的主流框架，基于适配 Elasticsearch 7.x 的 `v7` 版本。框架采用构建器模式，无需手动拼 JSON，提供强类型、易调试、并发安全的 API。"
tags: ["golang", "elasticsearch", "elastic"]
category: "golang"
