---
title: "sync.WaitGroup 完全指南"
date: "2025-12-28"
summary: "`sync.WaitGroup` 是 Go 语言中用于等待一组 goroutine 全部执行完成的核心同步工具，常用来协调多个并发任务的结束时机，避免主 goroutine 提前退出导致子任务未执行完。"
tags: ["golang", "sync", "waitgroup"]
category: "golang"
