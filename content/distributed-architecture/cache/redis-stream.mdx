---
title: "1. 向 Stream 中添加消息（XADD）"
date: "2026-01-10"
summary: "# 格式：XADD key ID field1 value1 field2 value2 ... # * 表示让 Redis 自动生成 ID（推荐） 127.0.0.1:6379> XADD mystream * name Alice age 25 \"1736400000000-0\"  # 返回自动生成的消息ID"
tags: ["Redis", "Stream"]
category: "cache"
